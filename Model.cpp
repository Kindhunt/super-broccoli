...
std::vector<Texture> Model::getTextures()
{
	...
	for (unsigned int i = 0; i < JSON["images"].size(); i++)
	{
		...
		for (unsigned int j = 0; j < loadedTexName.size(); i++)
		{
...
void Model::loadMesh(unsigned int indMesh)
{
	...
	std::vector<Vertex> vertices = assambleVertices(positions, normals, texUVs);
...
std::vector<Vertex> Model::assambleVertices
(
